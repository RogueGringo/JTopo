...
(function () {
  ...
  var PANELS = {
    ...
    'panel-killshot': {
      ...
      data: 'EVEN=12.713 \u00b7 ZETA=11.784 \u00b7 GUE=14.970\u00b10.198 \u00b7 \u03b6 BELOW ALL 10 (p\u22480.09)'
    },
    'panel-connection': {
    ...
    'panel-k-journey': {
      ...
      data: 'K=100\u219219.6% \u00b7 K=200\u219221.5% \u00b7 K=400\u219221.6% \u00b7 K=800\u21929.3% \u00b7 OPEN'
    },
    'panel-matrix-free': {
    ...
    'panel-constant': {
      ...
      body: '<p>The premium is a <strong>finite-K</strong> quantity. Measured across K:</p><p>K=100 (25 primes): 19.6%</p><p>K=200 (46 primes): 21.5%</p><p>K=400 (78 primes): 21.6%</p><p>K=800: 9.3%</p><p>It is roughly flat across K=200\u2192400 (21.5% \u2192 21.6%), then drops to 9.3% at K=800. Whether the premium converges to a nonzero limit as K \u2192 \u221e is an <strong>open scaling question</strong>. The K=800 drop has two live explanations that are not yet separated: Lanczos convergence degradation at the larger matrix dimension, or a real optimal "Fourier bandwidth" for detecting arithmetic structure.</p><p>It should not be read as a fixed constant of nature. The recommended \u2014 and not-yet-completed \u2014 next steps are a K=800 (and K=1600) sweep cross-validated against a dense solver, and a full Dumitriu\u2013Edelman ensemble (\u2265100\u20131000 realizations) at K=400.</p>',
      data: 'K=100\u219219.6% \u00b7 K=200\u219221.5% \u00b7 K=400\u219221.6% \u00b7 K=800\u21929.3% \u00b7 OPEN'
    }
  };
